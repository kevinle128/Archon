/**
 * Pinned todo strip for the Legacy node room: one collapsible fold of the
...
// The Legacy surface's running colour is --accent-bright.
const RUNNING_MARKER = 'shadow-[inset_2px_0_0_var(--accent-bright)]';
...
function TodoStripRow({ item, current }: { item: TodoItem; current: boolean }): React.ReactElement {
