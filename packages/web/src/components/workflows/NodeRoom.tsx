...
function markdownTextOf(node: React.ReactNode): string {
...
const TOOL_BODY_MARKDOWN_COMPONENTS: Components = {
  ...
  blockquote: ({ children }): React.ReactElement => (
...
function ToolBodyMarkdown({ markdown }: { markdown: string }): React.ReactElement {
  return (
    <ReactMarkdown
      remarkPlugins={REMARK_PLUGINS}
      rehypePlugins={REHYPE_PLUGINS}
