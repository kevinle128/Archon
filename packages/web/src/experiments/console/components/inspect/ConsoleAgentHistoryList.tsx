...
// Console-local copy of the Legacy renderer: the data contract — FileDiff
// plus toHunkData — is shared; the component is not, and neither surface
// imports the differ.
 ...
 */
function InlineDiff({ diff }: { diff: FileDiff }): ReactElement {
