 ...
 * handle; generating is a lifecycle no-op. No request body, no JSON content
 * type, no auto-retry, no local sub-state update. Refusals normalize through
 * SteeringRequestError like the other steering helpers.
 */
